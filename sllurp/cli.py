...
@click.option(
    ...
    type=str,
    default="1",
    help="comma-separated list of antennas to use (0=all;" " default 1)",
)
@click.option(
    "-X", "--tx-power", type=int, default=0, help="transmit power (default 0=max power)"
)
@click.option("-T", "--tari", type=int, default=0, help="Tari value (default 0=auto)")
@click.option("-s", "--session", type=int, default=2, help="Gen2 session (default 2)")
...
@click.option(
    ...
    default=[],
    multiple=True,
    help=("Filter inventory on EPC (or prefix of EPC); multiple" " args allowed"),
)
@click.option(
    "--keepalive-interval",
    type=int,
...
@click.option("-r", "--read-words", type=int, help="Read N words from tag memory")
@click.option("-w", "--write-words", type=int, help="Write N words to tag memory")
@click.option(
    "-c",
    "--count",
    type=int,
