...
ROSpecState_Name2Type = {"Disabled": 0, "Inactive": 1, "Active": 2}

ROSpecState_Type2Name = reverse_dict(ROSpecState_Name2Type)

# 10.2.1.1.1 ROSpec Start trigger
ROSpecStartTriggerType_Name2Type = {"Null": 0, "Immediate": 1, "Periodic": 2, "GPI": 3}
...
AccessReportTrigger_Name2Type = {"Upon_ROReport": 0, "Upon_End_Of_AccessSpec": 1}
...
def basic_param_encode_generator(pack_func=None, *args):
    ...
    if not args:
        raise LLRPError(
            "Error basic_param_encode_generator used with a pack "
...
def basic_auto_param_encode_generator(pack_func=None, *args):
    ...
    if not args:
        raise LLRPError(
            "Error basic_auto_param_encode_generator used with a "
...
def basic_auto_param_decode_generator(unpack_func, unpack_size, *args):
    ...
    if not args:
        raise LLRPError(
            "Error basic_auto_param_decode_generator used with a "
...
def decode_all_parameters(data, name=None, par_dict=None, n_fields=None):
    ...
    while start_pos < datalen:
        ...
        if sublength == 0:
            logger.error(
                "Loop in parameter body decoding (%d bytes left)", datalen - start_pos
            )
            break
        start_pos += sublength
...
def encode_param(name, par):
    ...
    if param_info.get("tv_encoded", False):
        ...
        if name != "CustomParameter":
            ...
            subtype = par["Subtype"]
        data = par_custom_header_pack(
            param_type, par_custom_header_len + len(sub_data), vendorid, subtype
        )
    else:
    ...
    for key, is_multiple in param_info["auto_fields"]:
        ...
        if not is_multiple:
            ...
            if not isinstance(value, list):
                logger.warning(
                    'Encoding error: "%s" parameter content should '
                    "be a list. Skipping...",
                    key,
                )
                continue
...
Message_struct["GET_READER_CAPABILITIES"] = {
    "type": 1,
    "fields": ["ID", "RequestedData"],
    "o_fields": ["ImpinjRequestedData"],
...
Message_struct["GET_READER_CONFIG"] = {
    "type": 2,
    "fields": ["ID", "AntennaID", "RequestedData", "GPIPortNum", "GPOPortNum"],
    "o_fields": ["ImpinjRequestedData"],
...
Message_struct["READER_EVENT_NOTIFICATION"] = {
    ...
    "o_fields": ["ReaderEventNotificationData"],
    "encode": encode_all_parameters,
    "decode": decode_generic_message,
}
...
Param_struct["TransmitPowerLevelTableEntry"] = {
    "type": 145,
    "fields": ["Index", "TransmitPowerValue"],
    "decode": basic_param_decode_generator(
        ushort_ushort_unpack, "Index", "TransmitPowerValue"
    ),
}
...
Param_struct["FrequencyInformation"] = {
    "type": 146,
    "fields": ["Hopping", "FrequencyHopTable", "FixedFrequencyTable"],
    "o_fields": ["FixedFrequencyTable"],
    "n_fields": [
        "FrequencyHopTable",
    ],
...
def decode_FrequencyHopTable(data, name=None):
    ...
    # Decode fields
    par["HopTableId"], flags, par["NumHops"] = ubyte_ubyte_ushort_unpack(
        data[:ubyte_ubyte_ushort_size]
    )
...
def decode_C1G2LLRPCapabilities(data, name=None):
    ...
    flags, par["MaxNumSelectFiltersPerQuery"] = ubyte_ushort_unpack(data)
...
Param_struct["UHFC1G2RFModeTable"] = {
    "type": 328,
    "fields": [],
    "n_fields": ["UHFC1G2RFModeTableEntry"],
    "decode": decode_all_parameters,
}
...
Param_struct["RFSurveyFrequencyCapabilities"] = {
    "type": 365,
    "fields": ["MinimumFrequency", "MaximumFrequency"],
    "decode": basic_param_decode_generator(
        uint_uint_unpack, "MinimumFrequency", "MaximumFrequency"
    ),
}
...
def decode_LLRPCapabilities(data, name=None):
    ...
    (
        ...
        par["MaxNumOpSpecsPerAccessSpec"],
    ) = llrp_capabilities_unpack(data)
...
Param_struct["GeneralDeviceCapabilities"] = {
    ...
    "o_fields": ["GPIOCapabilities", "MaximumReceiveSensitivity"],
    "n_fields": [
        "ReceiveSensitivityTableEntry",
        "PerAntennaReceiveSensitivityRange",
        "PerAntennaAirProtocol",
...
Param_struct["MaximumReceiveSensitivity"] = {
    "type": 363,
    "fields": ["MaximumSensitivityValue"],
    "decode": basic_param_decode_generator(ushort_unpack, "MaximumSensitivityValue"),
}


Param_struct["ReceiveSensitivityTableEntry"] = {
    "type": 139,
    "fields": ["Index", "ReceiveSensitivityValue"],
    "decode": basic_param_decode_generator(
        ushort_ushort_unpack, "Index", "ReceiveSensitivityValue"
    ),
}
...
Param_struct["PerAntennaReceiveSensitivityRange"] = {
    "type": 149,
    "fields": ["AntennaID", "ReceiveSensitivityIndexMin", "ReceiveSensitivityIndexMax"],
    "decode": basic_param_decode_generator(
        ushort_ushort_ushort_unpack,
        "AntennaID",
...
def decode_PerAntennaAirProtocol(data, name=None):
    ...
    # Decode fields
    par["AntennaID"], par["NumProtocols"] = ushort_ushort_unpack(
        data[:ushort_ushort_size]
    )
...
Param_struct["PerAntennaAirProtocol"] = {
    "type": 140,
    "fields": ["AntennaID", "NumProtocols", "ProtocolID"],
...
Param_struct["GPIOCapabilities"] = {
    "type": 141,
    "fields": ["NumGPIs", "NumGPOs"],
    "decode": basic_param_decode_generator(ushort_ushort_unpack, "NumGPIs", "NumGPOs"),
}
...
def encode_AccessSpec(par, param_info):
    ...
    packed = access_spec_pack(
        int(par["AccessSpecID"]),
        int(par["AntennaID"]),
        par["ProtocolID"],
        current_state,
        par["ROSpecID"],
...
def encode_AccessSpecStopTrigger(par, param_info):
    return ubyte_ushort_pack(
        int(par["AccessSpecStopTriggerType"]), int(par["OperationCountValue"])
    )


Param_struct["AccessSpecStopTrigger"] = {
    "type": 208,
    "fields": ["AccessSpecStopTriggerType", "OperationCountValue"],
...
def encode_C1G2TargetTag(par, param_info):
    ...
    data = [ubyte_ushort_ushort_pack(MB_M_byte, int(par["Pointer"]), mask_bitcount)]
    if mask_bitcount:
...
Param_struct["C1G2Lock"] = {
    "type": 344,
    "fields": ["OpSpecID", "AccessPassword"],
    "n_fields": [
        "C1G2LockPayload",
    ],
...
Param_struct["ROBoundarySpec"] = {
    "type": 178,
    "o_fields": ["ROSpecStartTrigger", "ROSpecStopTrigger"],
    "encode": encode_all_parameters,
    "decode": decode_all_parameters,
}
...
Param_struct["ROSpecStartTrigger"] = {
    ...
    "o_fields": ["PeriodicTriggerValue", "GPITriggerValue"],
    "encode": encode_ROSpecStartTrigger,
    "decode": basic_auto_param_decode_generator(
        ubyte_unpack, ubyte_size, "ROSpecStartTriggerType"
    ),
}
...
Param_struct["PeriodicTriggerValue"] = {
    ...
    "encode": basic_auto_param_encode_generator(uint_uint_pack, "Offset", "Period"),
    "decode": basic_auto_param_decode_generator(
        uint_uint_unpack,
        uint_uint_size,
        "Offset",
...
def encode_GPITriggerValue(par, param_info):
    ...
    data = ushort_ubyte_uint_pack(par["GPIPortNum"], gpievent, int(par["Timeout"]))
    return data
...
def decode_GPITriggerValue(data, name=None):
    ...
    gpi_port_num, gpi_event, timeout = ushort_ubyte_uint_unpack(
        data[:ushort_ubyte_uint_size]
    )
...
def decode_AISPec(data, name=None):
    ...
    par = {
        ...
        "AntennaID": [
            ushort_unpack(antenna_ids[2 * b : 2 * b + ushort_size])[0]
...
Param_struct["AISpec"] = {
    ...
    "n_fields": ["InventoryParameterSpec"],
...
def encode_TagObservationTrigger(par, param_info):
    ...
    return tagobservationtrigger_pack(t_type, 0, n_tags, n_attempts, t, timeout)


def decode_TagObservationTrigger(data, name=None):
    logger.debugfast("decode_TagObservationTrigger")

    trigger_type, _, number_of_tags, number_of_attempts, t, timeout = (
...
Param_struct["TagObservationTrigger"] = {
    "type": 185,
    "fields": ["TriggerType", "NumberOfTags", "NumberOfAttempts", "T", "Timeout"],
...
Param_struct["InventoryParameterSpec"] = {
    ...
    "n_fields": ["AntennaConfiguration"],
    "encode": basic_auto_param_encode_generator(
        ushort_ubyte_pack, "InventoryParameterSpecID", "ProtocolID"
    ),
    "decode": basic_auto_param_decode_generator(
        ushort_ubyte_unpack, ushort_ubyte_size, "InventoryParameterSpecID", "ProtocolID"
    ),
}
...
Param_struct["LLRPConfigurationStateValue"] = {
    ...
    "decode": basic_param_decode_generator(uint_unpack, "LLRPConfigurationStateValue"),
}
...
def decode_Identification(data, name=None):
    ...
    ret["ReaderID"] = hexlify(data[ubyte_ushort_size : ubyte_ushort_size + bytecount])
...
Param_struct["KeepaliveSpec"] = {
    ...
    "encode": basic_auto_param_encode_generator(
        ubyte_uint_pack, "KeepaliveTriggerType", "TimeInterval"
    ),
}
...
def decode_AntennaProperties(data, name=None):
    ...
    flags, par["AntennaID"], par["AntennaGain"] = ubyte_ushort_short_unpack(data)
...
Param_struct["AntennaConfiguration"] = {
    ...
    "decode": basic_auto_param_decode_generator(
        ushort_unpack, ushort_size, "AntennaID"
    ),
}
...
Param_struct["RFReceiver"] = {
    ...
    "decode": basic_param_decode_generator(ushort_unpack, "ReceiverSensitivity"),
}
...
Param_struct["RFTransmitter"] = {
    ...
    "encode": basic_param_encode_generator(
        ushort_ushort_ushort_pack, "HopTableId", "ChannelIndex", "TransmitPower"
    ),
    "decode": basic_param_decode_generator(
        ushort_ushort_ushort_unpack, "HopTableId", "ChannelIndex", "TransmitPower"
    ),
}
...
def encode_GPIPortCurrentState(par, param_info):
    ...
    data = ushort_ubyte_ubyte_pack(par["GPIPortNum"], gpiconfig, 0)
    return data
...
Param_struct["GPIPortCurrentState"] = {
    "type": 225,
    "fields": ["GPIPortNum", "GPIConfig", "GPIState"],
...
def decode_EventsAndReports(data, name=None):
    ...
    par = {"HoldEventsAndReportsUponReconnect": flags & BIT(7) == BIT(7)}
...
def decode_C1G2InventoryCommand(data, name=None):
    ...
    par, _ = decode_all_parameters(data[ubyte_size:], "C1G2InventoryCommand", par)
...
def encode_C1G2TagInventoryMask(par, param_info):
    ...
    data = ubyte_ushort_ushort_pack(par["MB"] << 6, par["Pointer"], tag_mask_bitcount)
    data += tag_mask
    return data
...
Param_struct["C1G2RFControl"] = {
    ...
    "encode": basic_param_encode_generator(ushort_ushort_pack, "ModeIndex", "Tari"),
    "decode": basic_param_decode_generator(ushort_ushort_unpack, "ModeIndex", "Tari"),
}


# 16.3.1.2.1.3 C1G2SingulationControl Parameter
def encode_C1G2SingulationControl(par, param_info):
    return ubyte_ushort_uint_pack(
        par["Session"] << 6, par["TagPopulation"], par["TagTransitTime"]
    )
...
def decode_C1G2SingulationControl(data, name=None):
    ...
    bitfield, par["TagPopulation"], par["TagTransitTime"] = ubyte_ushort_uint_unpack(
...
def decode_ROReportSpec(data, name=None):
    ...
    par, _ = decode_all_parameters(data[ubyte_ushort_size:], "ROReportSpec", par)
    return par, ""
...
def encode_ReaderEventNotificationSpec(par, param_info):
    ...
    for ev_type, flag in states.items():
        if ev_type not in EventState_Name2Value:
            ...
            continue
        eventstate_par = {"EventType": ev_type, "NotificationState": flag}
...
Param_struct["EventNotificationState"] = {
    "type": 245,
    "fields": ["EventType", "NotificationState"],
...
def decode_basic_OpSpecResult(data, name=None):
    ...
    par["Result"], par["OpSpecID"] = ubyte_ushort_unpack(data[:ubyte_ushort_size])
...
Param_struct["C1G2GetBlockPermalockStatusOpSpecResult"] = {
    "type": 362,
    "fields": ["Result", "OpSpecID", "StatusWordCount", "PermalockStatus"],
...
Param_struct["EPC"] = {"type": 241, "fields": [], "decode": decode_EPCData}
...
Param_struct["C1G2SingulationDetails"] = {
    ...
    "encode": basic_param_encode_generator(
        ushort_ushort_pack, "NumCollisionSlots", "NumEmptySlots"
    ),
    "decode": basic_param_decode_generator(
        ushort_ushort_unpack, "NumCollisionSlots", "NumEmptySlots"
    ),
}
...
Param_struct["HoppingEvent"] = {
    "type": 247,
    "fields": ["HopTableID", "NextChannelIndex"],
    "encode": basic_param_encode_generator(
        ushort_ushort_pack, "HopTableID", "NextChannelIndex"
    ),
    "decode": basic_param_decode_generator(
        ushort_ushort_unpack, "HopTableID", "NextChannelIndex"
    ),
}
...
def decode_ROSpecEvent(data, name=None):
    ...
    event_type, par["ROSpecID"], par["PreemptingROSpecID"] = ubyte_uint_uint_unpack(
        data
    )
...
Param_struct["ROSpecEvent"] = {
    "type": 249,
    "fields": ["EventType", "ROSpecID", "PreemptingROSpecID"],
...
Param_struct["ReportBufferLevelWarning"] = {
    "type": 250,
    "fields": ["ReportBufferPercentageFull"],
    "encode": basic_param_encode_generator(ubyte_pack, "ReportBufferPercentageFull"),
    "decode": basic_param_decode_generator(ubyte_unpack, "ReportBufferPercentageFull"),
}
...
def decode_RFSurveyEvent(data, name=None):
    ...
    event_type, par["ROSpecID"], par["SpecIndex"] = ubyte_uint_ushort_unpack(data)
...
Param_struct["RFSurveyEvent"] = {
    "type": 253,
    "fields": ["EventType", "ROSpecID", "SpecIndex"],
...
Param_struct["AISpecEvent"] = {
    ...
    "o_fields": ["C1G2SingulationDetails"],
...
Param_struct["SpecLoopEvent"] = {
    "type": 356,
    "fields": ["ROSpecID", "LoopCount"],
    "encode": basic_param_encode_generator(uint_uint_pack, "ROSpecID", "LoopCount"),
    "decode": basic_param_decode_generator(uint_uint_unpack, "ROSpecID", "LoopCount"),
}
...
Param_struct["LLRPStatus"] = {
    ...
    "o_fields": ["FieldError", "ParameterError"],
...
Param_struct["CustomParameter"] = {
    "type": TYPE_CUSTOM,
    "fields": ["VendorID", "Subtype", "Payload"],
...
Param_struct["ImpinjSubRegulatoryRegion"] = {
    ...
    "decode": basic_param_decode_generator(ushort_unpack, "RegulatoryRegion"),
}
...
Param_struct["ImpinjInventorySearchMode"] = {
    ...
    "vendorid": VENDOR_ID_IMPINJ,
    "subtype": 23,
    "fields": ["InventorySearchMode"],
    "encode": basic_auto_param_encode_generator(ushort_pack, "InventorySearchMode"),
    "decode": basic_auto_param_decode_generator(
        ushort_unpack, ushort_size, "InventorySearchMode"
    ),
}
...
def decode_ImpinjFixedFrequencyList(data, name=None):
    ...
    par["FixedFrequencyMode"], _, channel_count = ushort_ushort_ushort_unpack(
...
Param_struct["ImpinjFixedFrequencyList"] = {
    ...
    "vendorid": VENDOR_ID_IMPINJ,
    "subtype": 26,
    "fields": ["FixedFrequencyMode", "Reserved", "ChannelList"],
...
def decode_ImpinjReducedPowerFrequencyList(data, name=None):
    ...
    par["ReducedPowerMode"], _, channel_count = ushort_ushort_ushort_unpack(
        data[:ushort_ushort_ushort_size]
    )
...
Param_struct["ImpinjLowDutyCycle"] = {
    ...
    "vendorid": VENDOR_ID_IMPINJ,
    "subtype": 28,
    "fields": ["LowDutyCycleMode", "EmptyFieldTimeout", "FieldPingInterval"],
    "decode": basic_auto_param_decode_generator(
        ushort_ushort_ushort_unpack,
...
Param_struct["ImpinjFrequencyCapabilities"] = {
    ...
    "vendorid": VENDOR_ID_IMPINJ,
    "subtype": 30,
    "fields": ["NumFrequencies", "FrequencyList"],
...
Param_struct["ImpinjGPIDebounceConfiguration"] = {
    ...
    "decode": basic_param_decode_generator(
        ushort_uint_unpack, "GPIPortNum", "GPIDebounceTimerMSec"
    ),
}
...
Param_struct["ImpinjReaderTemperature"] = {
    ...
    "decode": basic_auto_param_decode_generator(
        short_unpack, short_size, "Temperature"
    ),
}
...
Param_struct["ImpinjLinkMonitorConfiguration"] = {
    ...
    "vendorid": VENDOR_ID_IMPINJ,
    "subtype": 38,
    "fields": ["LinkMonitorMode", "LinkDownThreshold"],
    "decode": basic_auto_param_decode_generator(
        ushort_ushort_unpack, ushort_ushort_size, "LinkMonitorMode", "LinkDownThreshold"
    ),
}
...
Param_struct["ImpinjReportBufferConfiguration"] = {
    ...
    "decode": basic_auto_param_decode_generator(
        ushort_unpack, ushort_size, "ReportBufferMode"
    ),
}
...
Param_struct["ImpinjBlockWriteWordCount"] = {
    ...
    "decode": basic_auto_param_decode_generator(
        ushort_unpack, ushort_size, "WordCount"
    ),
}
...
Param_struct["ImpinjGPSCoordinates"] = {
    ...
    "decode": basic_auto_param_decode_generator(
        uint_uint_unpack, uint_uint_size, "Latitude", "Longitude"
    ),
}
...
Param_struct["ImpinjGPSNMEASentences"] = {
    ...
    "vendorid": VENDOR_ID_IMPINJ,
    "subtype": 60,
    "o_fields": ["ImpinjGGASentence", "ImpinjRMCSentence"],
    "decode": decode_all_parameters,
}
...
Param_struct["ImpinjOpSpecRetryCount"] = {
    ...
    "decode": basic_auto_param_decode_generator(
        ushort_unpack, ushort_size, "RetryCount"
    ),
}
...
Param_struct["ImpinjAdvancedGPOConfiguration"] = {
    ...
    "vendorid": VENDOR_ID_IMPINJ,
    "subtype": 64,
    "fields": ["GPOPortNum", "GPOMode", "GPOPulseDurationMSec"],
    "decode": basic_auto_param_decode_generator(
        ushort_ushort_uint_unpack,
...
Param_struct["ImpinjEnableOptimizedRead"] = {
    ...
    "n_fields": ["C1G2Read"],
    "encode": basic_auto_param_encode_generator(ushort_pack, "OptimizedReadMode"),
    "decode": basic_auto_param_decode_generator(
        ushort_unpack, ushort_size, "OptimizedReadMode"
    ),
}
...
Param_struct["ImpinjEnableRFDopplerFrequency"] = {
    ...
    "vendorid": VENDOR_ID_IMPINJ,
    "subtype": 67,
    "fields": ["RFDopplerFrequencyMode"],
    "encode": basic_param_encode_generator(ushort_pack, "RFDopplerFrequencyMode"),
    "decode": basic_param_decode_generator(ushort_unpack, "RFDopplerFrequencyMode"),
}
...
Param_struct["ImpinjInventoryConfiguration"] = {
    ...
    "vendorid": VENDOR_ID_IMPINJ,
    "subtype": 69,
    "fields": ["EnableAntDwellTimeLimit", "EnableSelectGapClose"],
...
Param_struct["ImpinjAntennaEventHysteresis"] = {
    ...
    "encode": basic_auto_param_encode_generator(
        ulonglong_ulonglong_pack, "AntennaEventConnected", "AntennaEventDisconnected"
    ),
    "decode": basic_auto_param_decode_generator(
        ulonglong_ulonglong_unpack,
...
ImpinjHubConnectedType = {0: "Unknown", 1: "Disconnected", 2: "Connected"}
...
def decode_ImpinjHubConfiguration(data, name=None):
    ...
    par["Connected"] = ImpinjHubConnectedType.get(connected, ImpinjHubConnectedType[0])
...
def decode_ImpinjIntelligentAntennaManagement(data, name=None):
    ...
    flags = ubyte_unpack(data)[0]
    par = {"ManagementEnabled": flags & BIT(7) == BIT(7)}
...
def decode_ImpinjAntennaEventConfiguration(data, name=None):
    ...
    flags = ubyte_unpack(data[:ubyte_size])[0]
    par = {"EnableAntennaAttemptNotification": flags & BIT(7) == BIT(7)}

    data = data[ubyte_size:]
    par, _ = decode_all_parameters(data, "ImpinjAntennaEventConfiguration", par)
...
Param_struct["ImpinjAntennaEventConfiguration"] = {
    ...
    "vendorid": VENDOR_ID_IMPINJ,
    "subtype": 1576,
    "fields": ["EnableAntennaAttemptNotification"],
...
def decode_ImpinjRFPowerSweep(data, name=None):
    ...
    flags, par["MinimumPowerLevel"], par["PowerLevelStepSize"] = (
        ubyte_ushort_ushort_unpack(data)
    )
...
Param_struct["ImpinjRFPowerSweep"] = {
    ...
    "vendorid": VENDOR_ID_IMPINJ,
    "subtype": 1582,
    "fields": ["EnableRFPowerSweep", "MinimumPowerLevel", "PowerLevelStepSize"],
...
def decode_MotoAutonomousCapabilities(data, name=None):
    ...
    version, flags = uint_ubyte_unpack(data[:uint_ubyte_size])
    par = {"Version": version, "CanSupportAutonomousMode": flags & BIT(7) == BIT(7)}
...
Param_struct["MotoAutonomousCapabilities"] = {
    ...
    "vendorid": VENDOR_ID_MOTOROLA,
    "subtype": 100,
    "fields": ["Version", "CanSupportAutonomousMode"],
...
def decode_MotoTagEventSelector(data, name=None):
    ...
    par = {
        ...
        "ReportTagVisibilityChangeEvent": MotoTagEventSelector_Type2Name[
            report_tag_visibility_change_event
        ],
...
def decode_MotoTagReportMode(data, name=None):
    ...
    par = {"ReportFormat": MotoTagReportMode_Type2Name[report_format]}
...
Param_struct["MotoUTCTimestamp"] = {
    ...
    "decode": basic_auto_param_decode_generator(
        ulonglong_unpack, ulonglong_size, "Microseconds"
    ),
}
...
def decode_MotoFilterTimeRange(data, name=None):
    ...
    par = {"TimeFormat": time_format, "Match": Match_Type2Name[match]}
...
Param_struct["MotoFilterTimeRange"] = {
    ...
    "vendorid": VENDOR_ID_MOTOROLA,
    "subtype": 252,
    "fields": ["TimeFormat", "Match"],
    "n_fields": ["MotoFilterTimeFormatChoice"],
...
def decode_MotoFilterRSSIRange(data, name=None):
    ...
    par = {"Match": Match_Type2Name[match]}
...
def decode_MotoFilterList(data, name=None):
    ...
    par = {"UseFilter": use_filter & BIT(31) == BIT(31)}
...
def decode_MotoFilterTagList(data, name=None):
    ...
    par = {"Match": RuleType_Type2Name[match]}
...
class LLRPROSpec(dict):
    def __init__(
        ...
        # Sanity checks
        if rospecid <= 0:
            raise LLRPError("invalid ROSpec message ID {} (need >0)".format(rospecid))
        if priority < 0 or priority > 7:
            raise LLRPError("invalid ROSpec priority {} (need [0-7])".format(priority))
        ...
        if impinj_tag_content_selector:
            self["ROReportSpec"]["ImpinjTagReportContentSelector"] = {
                "ImpinjEnableRFPhaseAngle": {
                    "RFPhaseAngleMode": impinj_tag_content_selector[
                        "EnableRFPhaseAngle"
                    ],
                },
                "ImpinjEnablePeakRSSI": {
                    "PeakRSSIMode": impinj_tag_content_selector["EnablePeakRSSI"],
                },
                "ImpinjEnableRFDopplerFrequency": {
                    "RFDopplerFrequencyMode": impinj_tag_content_selector[
        ...
        for antid in antennas:
            ...
            antconf = {
                "AntennaID": antid,
                "RFTransmitter": {
                    "HopTableId": frequencies.get("HopTableId", DEFAULT_HOPTABLE_INDEX),
            ...
            if impinj_search_mode is not None:
                antconf["C1G2InventoryCommand"][0]["ImpinjInventorySearchMode"] = {
...
for source_struct, dest_dict, obj_name in [
    ...
    for msgname, msgstruct in source_struct.items():
        ...
        try:
            ...
            logger.warning(
                'Pseudo-warning: %s type %s lacks "type" field', obj_name, msgname
            )
            continue

        if (
            msgtype == TYPE_CUSTOM
            and (not vendorid or not subtype)
            and msgname not in ["CUSTOM_MESSAGE", "CustomParameter"]
        ):
            logger.warning(
                'Pseudo-warning: %s type %s lacks "vendorid" or ' '"subtype" fields',
                obj_name,
                msgname,
            )
            continue
